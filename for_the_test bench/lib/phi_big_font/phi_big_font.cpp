...
Updates:
03/05/2015: Modified to run on Arduino IDE 1.6.0
...
const char PROGMEM pbf_lcd_ch0[]={64,64,64,64,64,64,64,64,0};// 0, Empty
const char PROGMEM pbf_lcd_ch1[]={64,64,64,64,64,31,31,31,0};//1, Lower 3 lines 220
const char PROGMEM pbf_lcd_ch2[]={64,64,64,31,31,64,64,64,0};//2, middle 2 lines
const char PROGMEM pbf_lcd_ch3[]={64,64,64,31,31,31,31,31,0};//3, lower 5 lines
const char PROGMEM pbf_lcd_ch4[]={31,31,31,64,64,64,64,64,0};//4, upper 3 lines 223
const char PROGMEM pbf_lcd_ch5[]={31,31,31,64,64,31,31,31,0};//5, upper 3 lines + lower 3 lines
const char PROGMEM pbf_lcd_ch6[]={31,31,31,31,31,64,64,0};//6, upper 5 lines
const char PROGMEM pbf_lcd_ch7[]={31,31,31,31,31,31,31,31,0};//7, all 7 lines 219
const char PROGMEM * const pbf_ch_item[] = {pbf_lcd_ch0, pbf_lcd_ch1, pbf_lcd_ch2, pbf_lcd_ch3, pbf_lcd_ch4, pbf_lcd_ch5, pbf_lcd_ch6, pbf_lcd_ch7};
...
void init_big_font(LiquidCrystal_I2C *l)
{
