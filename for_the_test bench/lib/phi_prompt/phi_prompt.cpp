...
static LiquidCrystal_I2C * lcd;                 ///< This pointer stores the LiquidCrystal object for display purpose.
 ...
 */
void init_phi_prompt(LiquidCrystal_I2C *l, multiple_button_input *k[], char ** fk, int w, int h, char i)
{
  lcd=l;
  mbi_ptr=k;
  function_keys=fk;
 ...
 */
void simple_setup_6_buttons(LiquidCrystal_I2C * lcd, byte columns, byte rows, byte btn_u, byte btn_d, byte btn_l, byte btn_r, byte btn_b, byte btn_a)
{
 ...
 */
LiquidCrystal_I2C * simple_setup_phi_2(byte columns,byte rows)
{
  static char up_keys[]={"U"}; ///< All keys that act as the up key are listed here.
  static char down_keys[]={"D"}; ///< All keys that act as the down key are listed here.
  static char left_keys[]={"L"}; ///< All keys that act as the left key are listed here.
  ...
  static phi_button_groups* my_btns= new phi_button_groups(mapping, pins, 6);    
  static multiple_button_input * keypads[]={my_btns, 0};
  static LiquidCrystal_I2C * lcd= new LiquidCrystal_I2C(0x27, columns, rows);
  lcd->init();
  init_phi_prompt(lcd, keypads, fn_keys, columns, rows, '~');
}
 ...
 * \return It returns the liquid crystal object address, in case you need it for future reference.
 */
LiquidCrystal_I2C * simple_setup_phi_3(byte columns,byte rows)
{
  static char up_keys[]={"U"}; ///< All keys that act as the up key are listed here.
  static char down_keys[]={"D"}; ///< All keys that act as the down key are listed here.
  static char left_keys[]={"L"}; ///< All keys that act as the left key are listed here.
